...
0
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_pageblock.htm', 1570407150, '1', './data/template/1_1_portal_portalcp_portalblock.tpl.php', './template/default', 'portal/portalcp_portalblock')
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_pageblock.htm', 1570407150, '1', './data/template/1_1_portal_portalcp_portalblock.tpl.php', './template/default', 'portal/portalcp_portalblock')
|| checktplrefresh('./template/default/portal/portalcp_portalblock.htm', './template/default/portal/portalcp_nav.htm', 1570407150, '1', './data/template/1_1_portal_portalcp_portalblock.tpl.php', './template/default', 'portal/portalcp_portalblock')
