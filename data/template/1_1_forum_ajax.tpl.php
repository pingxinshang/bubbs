...
0
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/header_ajax.htm', 1570408329, '1', './data/template/1_1_forum_ajax.tpl.php', './template/default', 'forum/ajax')
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/footer_ajax.htm', 1570408329, '1', './data/template/1_1_forum_ajax.tpl.php', './template/default', 'forum/ajax')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
