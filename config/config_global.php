...
$_config['db']['1']['dbuser'] = 'bubbscc_discuz';
$_config['db']['1']['dbpw'] = '^ViR}cns1m?@';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'bubbscc_dz';
$_config['db']['1']['tablepre'] = 'bubbscc_dz';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = '3kJlxi_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'rVI9_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'd90ff7b9840c17b9cd481444b4c24fad4pGpW6c5y85c6XFpsT';
